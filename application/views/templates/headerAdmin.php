...
<div id="perspective" class="perspective effect-moveleft">
	...
	<div class="container">
      <div class="row"><div class="col-sm-3"><img src=<?php echo base_url(); ?>images/head_01.png >
				...
				<div class="col-sm-8 "><h3><a href=# style="color:white;"><?php echo $title; ?></a></h3>
				</div>
				</div>
		<div class="row"><div class="col-sm-12">		
		<nav class="navbar navbar-expand-xl sticky-top navbar-dark bg-primary">
		<?php echo anchor('Admin/view/EFT','Főoldal',"class='navbar-brand'");?>
		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
		<span class="navbar-toggler-icon"></span>
		</button>
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
            <li class="nav-item " ><?php echo anchor('Admin/view/folyoirat','Megfigyelt folyóiratok','class="nav-link"');?></li>
